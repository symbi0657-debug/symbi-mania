    ...
    <header className="fixed inset-x-0 top-0 z-30">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
        ...
        <nav className="hidden items-center gap-6 md:flex">
          <Link href="/passes" className="text-sm text-white/70 transition hover:text-white">
            Passes
          </Link>
          <Link href="/my-ticket" className="text-sm text-white/70 transition hover:text-white">
            My Ticket
          </Link>
